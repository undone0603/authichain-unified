 ...
 * ($29 Starter, $99 Creator, $299 DPP). The IDs below are TEST MODE and
 * only feed `server/webhooks/stripe-plan-detection.ts` plus
 * `scripts/setup-stripe-products.ts`. Do not send buyers here.
 *
