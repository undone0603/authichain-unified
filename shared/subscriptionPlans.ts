 ...
 *
 * `paymentLink` points at the live catalogue: these tiers' Stripe links
 * belonged to no live account (products archived 2026-08-31).
 */
export const SUBSCRIPTION_PLANS = {
  starter: {
    ...
    monthlyQuota: 100,
    perAuthCost: "0.49",
    paymentLink: "https://authichain.com/pricing",
    features: [
