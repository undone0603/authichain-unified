import { serial, integer, pgTable, text, timestamp, varchar, boolean, json, numeric, uuid, pgEnum, index, jsonb, real, uniqueIndex, } from 'drizzle-orm/pg-core';
// ─── Enums ──────────────────────────────────────────────────────────────────
...
// ─── Storymode Chapters ──────────────────────────────────────────────────────
export const storymodeChapters = pgTable('storymode_chapters', {
    id: uuid('id').primaryKey().defaultRandom(),
    ...
    storymodeChaptersUniqueIdx: index('idx_storymode_sku_chapter').on(table.skuId, table.chapterId),
}));
