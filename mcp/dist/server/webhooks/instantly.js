 ...
 */
import { getLeadByEmail, updateLead, logActivity, createSystemNotification } from "../db.js";
...
export async function handleInstantlyWebhook(payload) {
    ...
    if (eventType === "email_opened") {
        ...
        await createSystemNotification(1, // Admin
        "New Prospect Reply", `Lead ${email} has replied to an outreach sequence. Check Gmail immediately.`, "system", "/email-campaigns");
    }
