...
async function getAccessToken() {
    ...
    if (!refreshToken)
        throw new Error("LINKEDIN_REFRESH_TOKEN or LINKEDIN_ACCESS_TOKEN not set");
...
export async function postUpdate(params) {
    ...
    if (!author)
        throw new Error("LINKEDIN_PERSON_URN not set");
    // Build UGC post body
    const body = {
        author,
 ...
 */
export async function postLinkedInThread(texts, author = "person") {
    const results = [];
