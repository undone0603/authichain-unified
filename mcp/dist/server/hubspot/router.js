...
export const hubspotRouter = router({
    status: adminProcedure.query(async () => {
        if (!hubspot.isHubSpotConfigured())
            return { connected: false, contacts: 0, companies: 0, deals: 0, error: "HUBSPOT_SERVICE_KEY is not configured. Add it in Settings → Secrets." };
