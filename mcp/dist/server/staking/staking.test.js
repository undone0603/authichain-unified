...
describe("createStakingPosition", () => {
    ...
    it("throws when db is unavailable", async () => {
        ...
        await expect(createStakingPosition({ userId: 1, amount: 100, apy: 1200 })).rejects.toThrow("Database not available");
    });
    it("inserts with stringified amount and apy and rewardsEarned=0", async () => {
        ...
        expect(values).toHaveBeenCalledWith(expect.objectContaining({ amount: "250", apy: "800", rewardsEarned: "0", status: "active" }));
    });
});
...
describe("createTransaction", () => {
    ...
    it("inserts with stringified amount", async () => {
        ...
        expect(values).toHaveBeenCalledWith(expect.objectContaining({ amount: "100", type: "stake", status: "completed" }));
    });
});
