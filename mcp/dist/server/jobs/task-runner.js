...
import { runCheckReplies, runSendDemoPacket, runGenerateProposal, runSendContract, runAutoReply, } from '../agents/closer.js';
...
import { runBrowseResearchLead, runBrowseCompetitorMonitor, runBrowseScrapeIndustryNews, runBrowseVerifyProductUrl, } from '../agents/browser.js';
...
export async function runTask(task) {
    ...
    if (!claimed)
        return { ok: true }; // Another worker already claimed this task
    try {
        switch (task.kind) {
            case 'FIND_GOV_LEADS':
