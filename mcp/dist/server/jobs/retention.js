...
import { createSystemNotification, hasUserActionLogged, listHighScanUsers, listInactiveUsersNoRecentScans, listUsersForOnboardingStep, logActivity, } from "../db";
async function sendOnboarding(step, message) {
    ...
    for (const u of users) {
        ...
        if (await hasUserActionLogged(u.id, action))
            continue;
