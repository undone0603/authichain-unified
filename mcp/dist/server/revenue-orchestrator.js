...
import { computeLeadScore, logAutomationAudit, updateLeadScore, updateLeadStatus, upsertLeadByEmail, } from "./db";
...
function scoreToLeadStatus(score) {
    if (score >= 80)
        return "qualified";
    if (score >= 50)
        return "contacted";
...
export async function ingestLeadAndRoute(input) {
