...
async function launchMedtronicVideoBriefing() {
    ...
    try {
        ...
        const missionId = await createMission("MEDTECH_VIDEO_BRIEFING");
        ...
        await enqueueTask(missionId, "GENERATE_OUTREACH_VIDEO", {
            leadId: lead.id,
            firstName: "Michael",
            company: "Medtronic",
            segment: "MEDTECH",
        ...
        await enqueueTask(missionId, "DRAFT_OUTBOUND_EMAIL", {
