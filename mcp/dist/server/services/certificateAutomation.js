 ...
 */
export async function generateCertificateAfterPayment(certificateId) {
...
async function generateNFT(certificateData) {
 ...
 */
async function generateCertificatePDF(certificateData, nftData) {
  ...
  `;
    ...
    const { url } = await storagePut(`certificates/${filename}`, Buffer.from(html, 'utf-8'), 'text/html');
 ...
 */
async function sendCertificateEmail(certificateData, certificateUrl, nftData) {
