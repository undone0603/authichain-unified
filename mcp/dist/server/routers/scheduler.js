...
import { z } from "zod";
import { getRegisteredJobs, getJobHistory, runJobManually, getSystemStatus, toggleKillSwitch } from "../scheduled-jobs";
export const schedulerRouter = router({
    ...
    runManually: adminProcedure.input(z.object({
        ...
        if (!success)
            throw new TRPCError({ code: "NOT_FOUND", message: `Job "${input.jobName}" not found` });
