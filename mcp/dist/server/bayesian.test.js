...
import { betaMean, betaVariance, betaCI, sampleBeta, updatePrior, thompsonSample, selectTone, ucb1Score, rankMissions, bayesianPreamble, SEGMENT_PRIORS, SEGMENT_REVENUE, TONE_PRIORS, } from './_core/bayesian';
// ─── betaMean ─────────────────────────────────────────────────────────────────
describe('betaMean', () => {
    it('computes α/(α+β)', () => {
...
describe('updatePrior', () => {
    ...
    it('positive signals raise betaMean', () => {
        const positives = ['opened', 'clicked', 'replied', 'converted'];
    ...
    it('negative signals lower betaMean', () => {
        const negatives = ['unsubscribed', 'bounced'];
...
// ─── selectTone ──────────────────────────────────────────────────────────────
describe('selectTone', () => {
    const validTones = ['formal', 'warm', 'direct', 'story'];
...
describe('TONE_PRIORS', () => {
    const tones = ['formal', 'warm', 'direct', 'story'];
