 ...
 */
export async function analyzeProductDNA(imageUrl, productType) {
    ...
    try {
        ...
        if (!response.ok)
            throw new Error(`B44 Agent Error: ${response.statusText}`);
 ...
 */
export async function generateAudioStory(productMetadata) {
