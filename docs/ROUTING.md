...
Last updated 2026-09-20. Complements `docs/NETWORK.md`, `docs/ESTATE.md`, and `docs/ACCESS.md`.
...
| `/.well-known/x402.json`            | `authichain-com` (`tryHandleX402` catalog; also mounted on edge-router)                                                                                                                                                                      |
