--57e038690a763776acb30bfbda9f058a05da5836287341aeb6512582e5ee
...
// index.ts
var MARKETING_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
app.post("/webhook/github", async (c) => {
  ...
  const key = await crypto.subtle.importKey(
    "raw",
    enc.encode(c.env.GITHUB_WEBHOOK_SECRET),
...
app.use("*", async (c, next) => {
  ...
  const isApexOrWild = hostname === "authichain.com" || hostname === "www.authichain.com" || hostname.endsWith(".workers.dev");
...
app.all("*", async (c) => {
  ...
  const hostname = url.hostname;
  const isApex = hostname === "authichain.com" || hostname === "www.authichain.com";
  if (pathname === "/" && isApex) {
