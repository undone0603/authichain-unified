...
export const BRANDS: Record<BrandId, Brand> = {
  authichain: {
    ...
    description:
      "The authenticity layer for the agentic economy — blockchain-verified seals, AI image analysis, NFT certificates, MCP tools, and x402 pay-per-call verification.",
    accentToken: "accent",
    accentHex: "#00FFD1",
  ...
  qron: {
    ...
    description:
      "Turn any URL into a work of art. 11 illusion-diffusion styles, cosmic to cyberpunk, rendered in seconds and still scannable.",
    accentToken: "qron",
    accentHex: "#F59E0B",
  ...
  strainchain: {
    ...
    description:
      "Compliance-grade blockchain tracking for cultivators, processors, and dispensaries. METRC/BioTrack integration, strain NFTs, lab-cert hashing.",
    accentToken: "strain",
    accentHex: "#22C55E",
  ...
  govchain: {
    ...
    description:
      "Automated SAM.gov ingestion, AI scoring, proposal drafting, and on-chain proof-of-win NFTs for federal contractors.",
