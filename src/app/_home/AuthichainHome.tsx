  ...
  return (
    ...
    >
      <section className="max-w-7xl mx-auto px-6 pb-20">
        <h2 className="text-2xl font-semibold tracking-tight text-slate-950 mb-3">
          How it works
        </h2>
        <p className="text-sm text-slate-600 mb-8 max-w-2xl">
          Three realized steps. No new product surface.
        </p>
        <div className="grid gap-5 md:grid-cols-3">
          {[
            ...
            },
            {
              n: "02",
              t: "Bind",
              d: "Bind it to the physical item — a Living QR, a passport, or a label.",
            },
            {
              n: "03",
              t: "Verify",
              d: "Confirm authenticity from any camera. Agents can pay per call on /x402.",
            },
          ].map(s => (
            <article
              key={s.t}
      ...
      <section className="border-y border-slate-200 bg-slate-50 px-6 py-16">
        <div className="max-w-3xl">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-indigo-600 mb-3">
            Secondary
          </p>
          <h2 className="text-2xl font-semibold tracking-tight text-slate-950 mb-3">
          ...
          <p className="text-sm text-slate-600 mb-6">
            Funded agents verify a product for $0.05 USDC on Base. Public docs
            and unpaid 402 curls live at /x402.
          </p>
          <a
            href="/x402"
