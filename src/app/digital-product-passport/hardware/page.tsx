...
export const metadata: Metadata = {
  ...
  description:
    "Learn about the Elite Mobile App node and hardware integrations like NFC and RFID.",
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-20">
          <div className="protocol-card p-8 border-zinc-800 bg-zinc-950/50">
            ...
            <Link
              href="/elite"
              className="mt-8 inline-flex btn-gold px-6 py-3 text-[10px] font-black uppercase tracking-widest"
            >
              View Elite App
            </Link>
          </div>
          ...
          <div className="protocol-card p-8 border-zinc-800 bg-zinc-950/50">
            ...
            <p className="text-zinc-500 text-sm leading-relaxed font-medium uppercase tracking-tighter">
              StrainChain seamlessly bridges digital QRON artifacts with
              physical hardware. We support syncing with Metrc RFID tags for
              cannabis compliance, and encrypted NTAG424 DNA chips for luxury
              goods. The digital twin stays synchronized with the physical
              asset&apos;s telemetry in real-time.
            </p>
          </div>
        </div>
      </div>
