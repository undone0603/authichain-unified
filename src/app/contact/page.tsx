      ...
      <div className="min-h-screen bg-black text-white flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          ...
          <p className="text-zinc-400 mb-8">
            We&apos;ll respond within 24 hours. EU DPP demo requests get
            priority scheduling.
          </p>
          <Link
            href="/"
      ...
      <section className="max-w-2xl mx-auto px-6 pb-32">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6 text-center">
          <div className="border border-zinc-800 rounded p-6">
            ...
            <a
              href="mailto:authichain@gmail.com"
          ...
          <div className="border border-zinc-800 rounded p-6">
            ...
            <a
              href="mailto:eu-dpp@govchain.us"
              className="text-blue-400 hover:text-blue-300 text-sm"
            >
              eu-dpp@govchain.us
            </a>
          ...
          <div className="border border-zinc-800 rounded p-6">
            ...
            <a
              href="mailto:enterprise@authichain.com"
              className="text-blue-400 hover:text-blue-300 text-sm"
            >
