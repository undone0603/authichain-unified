...
const SEED_TESTIMONIALS = [
  { id: '1', name: 'Marcus T.', role: 'Marketing Director', company: 'RetailBrand Co.', avatar_initials: 'MT', rating: 5, text: 'QRON transformed how we track our in-store QR campaigns. The AI art styling alone is worth the upgrade â€” our scan rates doubled in the first month.', plan: 'pro', verified: true, created_at: '2026-03-12' },
