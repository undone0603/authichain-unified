...
const VISUAL_MODES = [
  {
    id: "static",
    label: "Static",
    desc: "Classic AI QR art for print & social. Max scan reliability.",
  },
  {
    id: "stereographic",
    label: "Stereographic",
    desc: "Depth-layered with parallax effect.",
  },
  {
    id: "holographic",
    label: "Holographic",
    desc: "Iridescent, light-reactive surface.",
  },
  {
    id: "memory",
    label: "Memory",
    desc: "Time-evolving design that changes on revisit.",
  },
  {
    id: "custom",
    label: "Custom Prompt",
    desc: "Full creative control over the AI generation.",
  },
];
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <header className="border-b border-white/10 px-6 py-4 flex items-center justify-between">
        ...
        <nav className="flex gap-4 text-sm">
          ...
          <Link
            href="/dashboard"
            className="bg-yellow-400 text-black px-4 py-1.5 rounded-full font-semibold hover:bg-yellow-300"
          >
            Dashboard
          </Link>
        </nav>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-white/60 text-lg max-w-xl mx-auto">
            Turn any URL into cryptographically signed AI art. Ed25519-sealed.
            Scannable everywhere. Ready in under 3 seconds.
          </p>
        </div>
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center text-white/30">
                  ...
                  <p className="text-xs mt-1">
                    Ed25519 signed &bull; Scan guaranteed
                  </p>
                </div>
              </div>
            )}
