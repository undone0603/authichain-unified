...
export default function GilmoreAutomotiveArt() {
  ...
  const [style, setStyle] = useState<
    "classic_photo" | "brushed_aluminum" | "blueprint" | "neon_night"
  >("classic_photo");
  const [isGenerating, setIsGenerating] = useState(false);
  const [result, setResult] = useState<{ imageUrl: string; id: string } | null>(
    null
  );
