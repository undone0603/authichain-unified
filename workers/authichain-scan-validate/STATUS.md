...
**LOC:** 193
**Cloudflare deployments:** none under `authichain-scan-validate` or `-staging`
...
The dir was renamed from `workers/scan-validate/` to
`workers/authichain-scan-validate/` in this PR to match the name
