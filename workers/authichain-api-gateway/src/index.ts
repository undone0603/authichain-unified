      ...
      if (path === '/api/v1/pricing') {
        return json({
          ...
          plans: [
            ...
            { name: 'QRON Starter Pack', price: '$29', requests: '100 generations', features: ['100 AI QR generations, never expire', 'Holographic & Memory modes', 'Designed for AuthiChain signed verification (in development)'], stripeLink: 'https://buy.stripe.com/eVq3cv2N3bVA8umazy1ND3E' },
