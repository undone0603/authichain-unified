...
const FAVICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none">
  <circle cx="32" cy="32" r="30" fill="#020817" stroke="#06b6d4" stroke-width="2"/>
  <polygon points="32,8 52,20 52,44 32,56 12,44 12,20" fill="#0d1425" stroke="#8b5cf6" stroke-width="1.5"/>
  <text x="32" y="38" font-family="monospace" font-size="16" font-weight="bold" fill="#06b6d4" text-anchor="middle">Q</text>
  <circle cx="32" cy="32" r="24" stroke="#06b6d4" stroke-width="0.5" stroke-dasharray="4 2" fill="none"/>
</svg>`;
...
const OG_IMAGE_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" width="1200" height="630">
  <defs>
    ...
    <pattern id="grid" width="48" height="48" patternUnits="userSpaceOnUse">
      <path d="M 48 0 L 0 0 0 48" fill="none" stroke="#06b6d4" stroke-opacity="0.06" stroke-width="1"/>
    </pattern>
  </defs>
  <rect width="1200" height="630" fill="url(#bg)"/>
  <rect width="1200" height="630" fill="url(#glow)"/>
  <rect width="1200" height="630" fill="url(#grid)"/>
  <text x="80" y="260" font-family="system-ui,sans-serif" font-size="96" font-weight="800" fill="white">$QRON</text>
  <text x="80" y="340" font-family="system-ui,sans-serif" font-size="40" fill="#06b6d4">Token Hub — Stake, Govern, Bridge</text>
  <text x="80" y="400" font-family="system-ui,sans-serif" font-size="28" fill="#64748b">Polygon PoS · ERC-20 · Up to 42.1% APY</text>
  <rect x="80" y="460" width="220" height="60" rx="8" fill="#06b6d4" opacity="0.9"/>
  <text x="190" y="498" font-family="system-ui,sans-serif" font-size="22" font-weight="700" fill="#020817" text-anchor="middle">Launch dApp →</text>
  <text x="1120" y="590" font-family="system-ui,sans-serif" font-size="22" fill="#1e2d4a" text-anchor="end">qron.space</text>
</svg>`;
...
export default {
  async fetch(request: Request): Promise<Response> {
    ...
    if (p === '/sitemap.xml') {
      const sitemap = \`<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><url><loc>https://qron.space/</loc><changefreq>weekly</changefreq><priority>1.0</priority></url></urlset>\`;
...
<meta property="og:description" content="The $QRON token powers staking, governance, and cross-chain bridge for the AuthiChain ecosystem.">
<meta property="og:image" content="https://qron.space/og-image.png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="$QRON Token Hub — Stake, Govern, Bridge">
<meta name="twitter:image" content="https://qron.space/og-image.png">
<script type="application/ld+json">{"@context":"https://schema.org","@type":"Organization","name":"QRON Token","url":"https://qron.space","description":"The $QRON token powers staking, governance, and cross-chain bridge for the AuthiChain ecosystem.","sameAs":["https://authichain.com"]}</script>
<script type="application/ld+json">{"@context":"https://schema.org","@type":"WebSite","name":"QRON Token Hub","url":"https://qron.space","description":"Stake $QRON to earn yield, govern protocol upgrades, and bridge seamlessly across Polygon, Ethereum, and Base."}</script>
</head><body>
<nav class="nav">
