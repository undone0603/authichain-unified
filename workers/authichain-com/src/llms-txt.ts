...
export function renderLlmsTxt(): string {
  return [
    ...
    "",
    "## Agent pay (x402)",
    `- Unpaid POST https://authichain.govchain.us/api/x402 returns HTTP 402 ($${X402_USD} USDC on Base)`,
    "- Catalog: https://authichain.govchain.us/api/x402/catalog",
    "- Listing pack: https://authichain.govchain.us/api/x402/listing",
    "- Growth registry: https://authichain.govchain.us/api/x402/growth",
    ...
    "- MCP: GET https://authichain.govchain.us/mcp (get_pricing free; tools/call verify is unpaid HTTP 402)",
    ...
    "- Pricing: https://authichain.govchain.us/pricing",
    "",
    "## Positioning",
