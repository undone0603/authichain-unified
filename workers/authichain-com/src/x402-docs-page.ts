  ...
  <div class="wrap panel-grid">
    ...
    <section class="card flow" aria-labelledby="flow-title">
      ...
      <ol>
        ...
        <li>The edge answers <code>402</code> with <code>x402Version: 1</code> JSON <code>accepts[]</code> (scheme <code>exact</code>, ${esc(p.network)} USDC, payTo above, plus EIP-712 extra for Circle USDC) and a v2 <code>PAYMENT-REQUIRED</code> header. Both declare <code>extensions.bazaar</code> so discovery clients can catalog the skill.</li>
