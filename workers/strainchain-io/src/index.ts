...
const FAVICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none">
  <rect width="64" height="64" rx="8" fill="#030c04"/>
  <ellipse cx="32" cy="28" rx="14" ry="20" fill="#071209" stroke="#10b981" stroke-width="1.5"/>
  <path d="M32 8 Q40 18 38 30 Q34 42 32 50 Q30 42 26 30 Q24 18 32 8z" fill="#10b981" opacity="0.5"/>
  <path d="M18 22 Q32 28 46 22" stroke="#10b981" stroke-width="1.5" fill="none"/>
  <path d="M16 32 Q32 38 48 32" stroke="#f59e0b" stroke-width="1" fill="none"/>
  <line x1="32" y1="8" x2="32" y2="56" stroke="#10b981" stroke-width="1" opacity="0.6"/>
</svg>`;
...
const OG_IMAGE_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" width="1200" height="630">
  <defs>
    ...
    <pattern id="grid" width="48" height="48" patternUnits="userSpaceOnUse">
      <path d="M 48 0 L 0 0 0 48" fill="none" stroke="#10b981" stroke-opacity="0.05" stroke-width="1"/>
    </pattern>
  </defs>
  <rect width="1200" height="630" fill="url(#bg)"/>
  <rect width="1200" height="630" fill="url(#glow)"/>
  <rect width="1200" height="630" fill="url(#grid)"/>
  <text x="80" y="260" font-family="system-ui,sans-serif" font-size="96" font-weight="800" fill="white">StrainChain</text>
  <text x="80" y="340" font-family="system-ui,sans-serif" font-size="40" fill="#10b981">Cannabis Supply Chain on Blockchain</text>
  <text x="80" y="400" font-family="system-ui,sans-serif" font-size="28" fill="#64748b">Strain NFTs · METRC Sync · 4-Layer Audit Trail</text>
  <rect x="80" y="460" width="240" height="60" rx="8" fill="#10b981" opacity="0.9"/>
  <text x="200" y="498" font-family="system-ui,sans-serif" font-size="22" font-weight="700" fill="#030c04" text-anchor="middle">Request Demo →</text>
  <text x="1120" y="590" font-family="system-ui,sans-serif" font-size="22" fill="#0f2b12" text-anchor="end">strainchain.io</text>
</svg>`;
...
export default {
  async fetch(request: Request): Promise<Response> {
    ...
    if (p === '/sitemap.xml') {
      const sitemap = \`<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><url><loc>https://strainchain.io/</loc><changefreq>weekly</changefreq><priority>1.0</priority></url></urlset>\`;
...
<meta property="og:description" content="End-to-end cannabis supply chain tracking: strain NFTs, compliance automation, 4-layer audit trail from seed to shelf.">
<meta property="og:image" content="https://strainchain.io/og-image.png">
...
<meta name="twitter:image" content="https://strainchain.io/og-image.png">
<script type="application/ld+json">{"@context":"https://schema.org","@type":"Organization","name":"StrainChain","url":"https://strainchain.io","description":"End-to-end cannabis supply chain tracking with blockchain provenance.","sameAs":["https://authichain.com"]}</script>
<script type="application/ld+json">{"@context":"https://schema.org","@type":"WebSite","name":"StrainChain","url":"https://strainchain.io","description":"Immutable strain NFTs, automated compliance reporting, and a 4-layer audit trail from seed to shelf."}</script>
</head><body>
<nav class="nav">
