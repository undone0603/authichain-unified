...
**LOC:** 552 (largest scaffolded worker)
**Cloudflare deployments:** none found under name `authichain-gateway`

Note: a separate worker named `authichain-api-gateway` IS deployed
(2026-04-23). That worker may have superseded this one, or they may
serve different roles. Verify before deploying or deleting.
