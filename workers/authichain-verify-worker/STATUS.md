...
**LOC:** 174
**Cloudflare deployments:** none under `authichain-verify-worker` or `-staging`
...
The dir was renamed from `workers/verify-worker/` to
`workers/authichain-verify-worker/` in this PR to match the name
