...
const FAVICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none">
  ...
  <rect x="29" y="28" width="6" height="26" fill="#3b82f6"/>
  <rect x="42" y="18" width="6" height="36" fill="#facc15"/>
  <path d="M8 14l20 8 28-12" stroke="#3b82f6" stroke-width="2" stroke-linecap="round"/>
</svg>`;
...
const OG_IMAGE_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" width="1200" height="630">
  <defs>
    ...
    <pattern id="grid" width="48" height="48" patternUnits="userSpaceOnUse">
      <path d="M 48 0 L 0 0 0 48" fill="none" stroke="#3b82f6" stroke-opacity="0.06" stroke-width="1"/>
    </pattern>
  </defs>
  <rect width="1200" height="630" fill="url(#bg)"/>
  <rect width="1200" height="630" fill="url(#grid)"/>
  <rect width="1200" height="630" fill="url(#glow)"/>
  <rect x="0" y="624" width="1200" height="6" fill="#3b82f6"/>
  <rect x="60" y="75" width="100" height="140" rx="4" fill="none" stroke="#3b82f6" stroke-width="2.5" opacity="0.7"/>
  <rect x="72" y="92" width="36" height="14" rx="2" fill="#facc15" opacity="0.85"/>
  <rect x="72" y="114" width="76" height="7" rx="2" fill="#3b82f6" opacity="0.5"/>
  <rect x="72" y="128" width="62" height="7" rx="2" fill="#3b82f6" opacity="0.5"/>
...
<nav class="nav">
  ...
  <a href="https://govchain.us/onboard" class="btn btn-primary">Request Access</a>
</nav>
...
<section id="pricing">
  ...
  <div class="pricing-grid">
    <div class="price-card"><h3>Contractor</h3><div class="price-amount">$299</div><div class="price-period">per month</div><ul class="price-features"><li>SAM.gov opportunity radar</li><li>AI fit-scoring</li><li>5 capability drafts / mo</li><li>Public datalog (read)</li></ul><a href="https://govchain.us/onboard" class="btn btn-outline" style="width:100%;text-align:center">Start Trial</a></div>
    <div class="price-card featured"><h3>Agency</h3><div class="price-amount">$799</div><div class="price-period">per month</div><ul class="price-features"><li>Everything in Contractor</li><li>Unlimited capability drafts</li><li>Made-in-USA provenance seals</li><li>FAR/DFARS/NIST exports</li><li>Deadline watchdog alerts</li></ul><a href="https://govchain.us/onboard" class="btn btn-primary" style="width:100%;text-align:center">Most Popular</a></div>
    <div class="price-card"><h3>Enterprise</h3><div class="price-amount">Custom</div><div class="price-period">prime & multi-team</div><ul class="price-features"><li>Multi-team workspaces</li><li>White-label public datalog</li><li>Sub-tier supply-chain anchoring</li><li>Dedicated compliance officer</li><li>SLA & SSO</li></ul><a href="https://govchain.us/onboard" class="btn btn-outline" style="width:100%;text-align:center">Contact Sales</a></div>
  </div>
</section>
...
<div class="cta-section">
  ...
  <a href="https://govchain.us/onboard" class="btn btn-primary" style="font-size:1.1rem;padding:1rem 2.5rem">Request Access</a>
</div>
