...
const FAVICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none">
  <rect width="64" height="64" rx="8" fill="#05060b"/>
  <path d="M32 6L8 18v16c0 13.6 10.24 26.4 24 30.4 13.76-4 24-16.8 24-30.4V18L32 6z" fill="#0a0c14" stroke="#3b82f6" stroke-width="1.5"/>
  <rect x="20" y="26" width="24" height="3" rx="1.5" fill="#facc15"/>
  <rect x="20" y="32" width="18" height="3" rx="1.5" fill="#3b82f6"/>
  <rect x="20" y="38" width="24" height="3" rx="1.5" fill="#facc15"/>
  <circle cx="32" cy="32" r="24" stroke="#3b82f6" stroke-width="0.4" opacity="0.3" fill="none"/>
</svg>`;
...
const OG_IMAGE_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" width="1200" height="630">
  <defs>
    ...
    <pattern id="grid" width="48" height="48" patternUnits="userSpaceOnUse">
      <path d="M 48 0 L 0 0 0 48" fill="none" stroke="#3b82f6" stroke-opacity="0.05" stroke-width="1"/>
    </pattern>
  </defs>
  <rect width="1200" height="630" fill="url(#bg)"/>
  <rect width="1200" height="630" fill="url(#glow)"/>
  <rect width="1200" height="630" fill="url(#grid)"/>
  <text x="80" y="260" font-family="system-ui,sans-serif" font-size="96" font-weight="800" fill="white">GovChain</text>
  <text x="80" y="340" font-family="system-ui,sans-serif" font-size="40" fill="#3b82f6">Federal Contract Intelligence</text>
  <text x="80" y="400" font-family="system-ui,sans-serif" font-size="28" fill="#7e93b8">AI Fit-Scoring · On-Chain Provenance · SAM.gov Intelligence</text>
  <rect x="80" y="460" width="260" height="60" rx="8" fill="#3b82f6" opacity="0.9"/>
  <text x="210" y="498" font-family="system-ui,sans-serif" font-size="22" font-weight="700" fill="white" text-anchor="middle">Request Access →</text>
  <text x="1120" y="590" font-family="system-ui,sans-serif" font-size="22" fill="#1e2d4a" text-anchor="end">govchain.us</text>
</svg>`;
...
export default {
  async fetch(request: Request): Promise<Response> {
    ...
    if (p === '/sitemap.xml') {
      const sitemap = \`<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><url><loc>https://govchain.us/</loc><changefreq>weekly</changefreq><priority>1.0</priority></url></urlset>\`;
...
<meta property="og:description" content="GovChain turns SAM.gov into pursue-ready intelligence: AI fit-scoring, auto-drafted capability statements, and an immutable on-chain public datalog.">
<meta property="og:image" content="https://govchain.us/og-image.png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="GovChain — Federal Contract Intelligence">
<meta name="twitter:image" content="https://govchain.us/og-image.png">
<script type="application/ld+json">{"@context":"https://schema.org","@type":"Organization","name":"GovChain","url":"https://govchain.us","description":"Federal contract intelligence and on-chain public provenance platform.","sameAs":["https://authichain.com"]}</script>
<script type="application/ld+json">{"@context":"https://schema.org","@type":"WebSite","name":"GovChain","url":"https://govchain.us","description":"GovChain turns SAM.gov into pursue-ready intelligence with AI fit-scoring and immutable on-chain provenance."}</script>
</head><body>
<nav class="nav">
