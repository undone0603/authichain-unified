...
<section class="estate-section" id="live">
  <div class="wrap">
    <h2>Live high-fit opportunities</h2>
    <p class="section-sub">Federal notices scored ≥70 by the GovChain engine, loaded from the live pipeline when the registry is available.</p>
...
${estateFeatures(
  ...
  "What GovChain does that a SAM.gov search and a folder of PDFs cannot.",
  [
...
${estateCtaBand({
  title: "Pursue smarter. Prove everything.",
  lede: "Onboard is the live conversion path for govchain.us. It proxies to the AuthiChain app intake.",
  actions: [
    { href: "/onboard", label: "Request access", primary: true },
    { href: "/opportunities", label: "Browse opportunities", primary: false },
  ],
