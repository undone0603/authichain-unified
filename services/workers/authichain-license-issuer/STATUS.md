...
**LOC:** 644 (largest scaffolded worker)
**Cloudflare deployments:** none found under name `authichain-license-issuer`
...
The dir was renamed from `workers/license-issuer/` to
`workers/authichain-license-issuer/` in this PR to match the name
