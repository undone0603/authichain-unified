...
CREATE TABLE "autopilot_config" (
	...
	"updatedAt" timestamp DEFAULT now() NOT NULL,
	"createdAt" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "autopilot_config_tenantId_unique" UNIQUE("tenantId")
);
--> statement-breakpoint
...
CREATE TABLE "brands" (
	...
	"qron_staked" numeric DEFAULT '0' NOT NULL,
	"wallet_address" text,
	"unit_cost_discount" numeric DEFAULT '0' NOT NULL,
	"base_unit_cost" numeric DEFAULT '0.05' NOT NULL,
...
CREATE TABLE "feedback_votes" (
	...
	"userId" integer NOT NULL,
	"voteType" varchar(32) DEFAULT 'up',
	"createdAt" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "nft_collections" (
	...
	"chainId" integer DEFAULT 137,
	"imageUrl" text,
	"totalSupply" integer DEFAULT 0,
	"floorPrice" numeric(18, 8),
	"status" varchar(50) DEFAULT 'active',
	"metadata" json,
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "staking_positions" (
	...
	"rewardsEarned" numeric(20, 9) DEFAULT '0',
...
CREATE TABLE "users" (
	...
	"affiliate_id" text,
	"referred_by" text,
	"story_mode_enabled" boolean DEFAULT false,
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL,
	"lastSignedIn" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "users_openId_unique" UNIQUE("openId"),
	CONSTRAINT "users_stripeCustomerId_unique" UNIQUE("stripeCustomerId"),
	CONSTRAINT "users_affiliate_id_unique" UNIQUE("affiliate_id")
);
--> statement-breakpoint
...
CREATE TABLE "visitor_profiles" (
	...
	"createdAt" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "visitor_profiles_sessionId_unique" UNIQUE("sessionId")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "idx_brands_domain" ON "brands" USING btree ("domain");--> statement-breakpoint
CREATE INDEX "idx_qrcodes_user_id" ON "qr_codes" USING btree ("userId");--> statement-breakpoint
CREATE INDEX "idx_qrcodes_short_code" ON "qr_codes" USING btree ("short_code");--> statement-breakpoint
CREATE INDEX "idx_redirect_qron" ON "redirect_rules" USING btree ("qron_id");--> statement-breakpoint
CREATE INDEX "idx_telemetry_theater" ON "telemetry_events" USING btree ("theater");--> statement-breakpoint
CREATE INDEX "idx_telemetry_hash" ON "telemetry_events" USING btree ("state_hash");